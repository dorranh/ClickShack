...
#include "ported_clickhouse/core/Defines.h"
#include "ported_clickhouse/parsers/IAST_fwd.h"
#include "ported_clickhouse/parsers/LiteralTokenInfo.h"
...
#include "ported_clickhouse/common/checkStackSize.h"
...
struct HighlightedRange
{
    ...
    bool operator<(const HighlightedRange & other) const
    {
